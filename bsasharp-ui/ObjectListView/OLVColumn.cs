...
namespace BrightIdeasSoftware
{
    ...
    public partial class OLVColumn : ColumnHeader
    {
        ...
        public bool ShowTextInHeader { get; set; }
        ...
        new public HorizontalAlignment TextAlign
        {
            get
            {
                return _textAlign.HasValue ? _textAlign.Value : base.TextAlign;
            }
            set
            {
                _textAlign = value;
        ...
        /// </remarks>
        [Category("ObjectListView"), Description("The name of the property or method that should be called to get the aspect to display in this column"), DefaultValue(false)]
        ...
        {
            return DynamicHelp.Get(rowObject, AspectName);
        }
        ...
        public Object GetImage(object rowObject)
        {
            ...
            if (!String.IsNullOrEmpty(ImageAspectName))
                return DynamicHelp.Get(rowObject, ImageAspectName);
        ...
        {
            return ValueToString(rowObject);
        }
        ...
        {
            DynamicHelp.Set(rowObject, AspectName, newValue);
        }
        ...
        public string ValueToString(object rowObject, object value = null)
        {
            ...
            if (AspectToStringConverter != null)
                return AspectToStringConverter(rowObject, value) ?? String.Empty;
        ...
        public Type DataType
        {
            get
            {
                if (_dataType == null)
                {
                    ObjectListView olv = ListView as ObjectListView;
                    if (olv != null)
                    {
