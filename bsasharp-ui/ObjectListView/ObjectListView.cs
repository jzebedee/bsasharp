...
namespace BrightIdeasSoftware
{
    ...
    public partial class ObjectListView : ListView, ISupportInitialize
    {
        ...
        /// </summary>
        static public SmoothingMode SmoothingMode
        {
            get { return sSmoothingMode; }
            set { sSmoothingMode = value; }
        }
        static private SmoothingMode sSmoothingMode =
            SmoothingMode.HighQuality;

        /// <summary>
        /// Gets or sets how should text be renderered.
        /// </summary>
        static public TextRenderingHint TextRenderingHint
        {
            get { return sTextRendereringHint; }
            set { sTextRendereringHint = value; }
        }
        static private TextRenderingHint sTextRendereringHint =
        ...
        static public string GroupTitleDefault
        {
            ...
            set { sGroupTitleDefault = value == null ? "{null}" : value; }
        ...
        new public ColumnHeaderCollection Columns
        {
            get
            {
                return base.Columns;
        ...
        void DropSinkCanDrop(object sender, OlvDropEventArgs e) { OnCanDrop(e); }
        void DropSinkDropped(object sender, OlvDropEventArgs e) { OnDropped(e); }
        void DropSinkModelCanDrop(object sender, ModelDropEventArgs e) { OnModelCanDrop(e); }
        void DropSinkModelDropped(object sender, ModelDropEventArgs e) { OnModelDropped(e); }
        ...
        public virtual Color UnfocusedHighlightBackgroundColorOrDefault
        {
            get
            {
                return UnfocusedHighlightBackgroundColor.IsEmpty ? SystemColors.Control : UnfocusedHighlightBackgroundColor;
            }
        }
        ...
        public virtual Color UnfocusedHighlightForegroundColorOrDefault
        {
            get
            {
                return UnfocusedHighlightForegroundColor.IsEmpty ? SystemColors.ControlText : UnfocusedHighlightForegroundColor;
            }
        }
        ...
        public virtual string CheckedAspectName
        {
            ...
            set
            {
                ...
                else
                {
                    ...
                    {
                        var result = DynamicHelp.Get(modelObject, checkedAspectName);
                        if (result.HasValue)
                    ...
                    CheckStatePutter = (Object modelObject, CheckState newValue) =>
                    {
                        if (TriStateCheckBoxes && newValue == CheckState.Indeterminate)
                            DynamicHelp.Set(modelObject, checkedAspectName, null);
                        else
                            DynamicHelp.Set(modelObject, checkedAspectName, newValue == CheckState.Checked);
...
#pragma warning restore 168
        ...
        protected virtual void CalculateOwnerDrawnHitTest(OlvListViewHitTestInfo hti, int x, int y)
        {
            ...
            IRenderer renderer = View == View.Details ? (hti.Column.Renderer ?? DefaultRenderer) : ItemRenderer;
        ...
        protected virtual bool HandleHitTest(ref Message m)
        {
            ...
            int checkBoxWidth = StateImageList.ImageSize.Width;
            ...
            Debug.WriteLine(lvhittestinfo.iItem);
            Debug.WriteLine(lvhittestinfo.flags);
...
#pragma warning restore 168
        ...
        protected virtual void PostProcessOneRow(int rowIndex, int displayIndex, OLVListItem olvi)
        {
            ...
            if (UseHyperlinks)
            {
                ApplyHyperlinkStyle(rowIndex, olvi);
            }
        ...
        public virtual void StartCellEdit(OLVListItem item, int subItemIndex)
        {
            ...
            Rectangle r = CalculateCellEditorBounds(item, subItemIndex, c.PreferredSize);
            c.Bounds = r;

            // Try to align the control as the column is aligned. Not all controls support this property
            DynamicHelp.Set(c, "TextAlign", column.TextAlign);
        ...
        protected virtual void SetControlValue(Control control, Object value, String stringValue)
        {
            ...
            if ((bool)DynamicHelp.Set(control, "Value", value))
                return;
        ...
        protected virtual void InitializeEmptyListMsgOverlay()
        {
            ...
            overlay.Alignment = ContentAlignment.MiddleCenter;
