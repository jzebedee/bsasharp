...
namespace BrightIdeasSoftware
{
    ...
    public class BaseRenderer : AbstractRenderer
    {
        ...
        public Object Aspect
        {
            ...
            {
                if (_aspect == null)
                    _aspect = _column.GetValue(_rowObject);
                return _aspect;
            }
            set { _aspect = value; }
        }
        ...
        {
            get { return _drawItemEventArgs; }
            set { _drawItemEventArgs = value; }
        }
        private DrawListViewItemEventArgs _drawItemEventArgs;
        ...
        private DrawListViewSubItemEventArgs _eventArgs;
        ...
        {
            get { return _listSubItem; }
            set { _listSubItem = value; }
        }
        private OLVListSubItem _listSubItem;
        ...
        {
            get { return _useCustomCheckboxImages; }
            set { _useCustomCheckboxImages = value; }
        }
        private bool _useCustomCheckboxImages;
        ...
        {
            HorizontalAlignment alignment = Column == null ? HorizontalAlignment.Left : Column.TextAlign;
            switch (alignment)
            {
        ...
        {
            Size checkBoxSize = (UseCustomCheckboxImages && ListView.StateImageList != null)
                ? ListView.StateImageList.ImageSize
        ...
        protected virtual int CalculateCheckBoxWidth(Graphics g)
        {
            ...
            if (UseCustomCheckboxImages && ListView.StateImageList != null)
                return ListView.StateImageList.ImageSize.Width;
        ...
        protected virtual int CalculateTextWidth(Graphics g, string txt)
        {
            ...
            if (UseGdiTextRendering)
            {
                ...
                return TextRenderer.MeasureText(g, txt, Font, proposedSize, TextFormatFlags.EndEllipsis | TextFormatFlags.NoPrefix).Width;
            }
        ...
        protected void StandardHitTest(Graphics g, OlvListViewHitTestInfo hti, Rectangle bounds, int x, int y)
        {
            ...
            {
                Rectangle r2 = CalculateCheckBoxBounds(g, r);
                Rectangle r3 = r2;
    ...
    public class MappedImageRenderer : BaseRenderer
    {
        ...
        public override void Render(Graphics g, Rectangle r)
        {
            ...
            ICollection aspectAsCollection = Aspect as ICollection;
    ...
    public class ImageRenderer : BaseRenderer
    {
        ...
        public override void Render(Graphics g, Rectangle r)
        {
            ...
            {
                ICollection imageSelectors = Aspect as ICollection;
        ...
        internal class AnimationState
        {
            ...
            public bool IsValid
            {
                get
                {
                    return (Image != null && FrameCount > 0);
                }
            }
    ...
    public class BarRenderer : BaseRenderer
    {
        ...
        public Pen Pen
        {
            get
            {
                if (_pen == null && !FrameColor.IsEmpty)
        ...
        public Brush Brush
        {
            get
            {
                if (_brush == null && !FillColor.IsEmpty)
        ...
        public Brush BackgroundBrush
        {
            get
            {
                if (_backgroundBrush == null && !BackgroundColor.IsEmpty)
        ...
        public override void Render(Graphics g, Rectangle r)
        {
            ...
            IConvertible convertable = Aspect as IConvertible;
            if (convertable == null)
                return;
    ...
    public class MultiImageRenderer : BaseRenderer
    {
        ...
        public int ImageIndex
        {
            get
            {
                if (_imageSelector is Int32)
                    return (Int32)_imageSelector;
                return -1;
            }
        ...
        public string ImageName
        {
            get
            {
                return _imageSelector as String;
            }
            set { _imageSelector = value; }
        }
    ...
    public class DescribedTaskRenderer : BaseRenderer
    {
        ...
        public Font TitleFontOrDefault
        {
            get
            {
                return TitleFont ?? ListView.Font;
            }
        }
        ...
        public Font DescriptionFontOrDefault
        {
            get
            {
                return DescriptionFont ?? ListView.Font;
            }
        }
        ...
        {
            get { return _descriptionAspectName; }
            set { _descriptionAspectName = value; }
        }
        private string _descriptionAspectName;
        ...
        protected virtual string GetDescription()
        {
            ...
            return DynamicHelp.Get(RowObject, DescriptionAspectName);
        }
        ...
        {
            Rectangle cellBounds = ApplyCellPadding(r);
