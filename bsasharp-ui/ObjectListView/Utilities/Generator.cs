...
namespace BrightIdeasSoftware
{
    ...
    public class Generator : IGenerator
    {
        ...
        protected virtual void GenerateChildrenDelegates(TreeListView tlv, PropertyInfo pinfo)
        {
            ...
            tlv.CanExpandGetter = x => !ObjectListView.IsEnumerableEmpty(DynamicHelp.Get(x, pinfo.Name) as IEnumerable);
            tlv.ChildrenGetter = x => DynamicHelp.Get(x, pinfo.Name) as IEnumerable;
        }
        #endregion
